var varint = require('./varint')
    , test = require('tape')
    , Buffer = require('../../../global/model/Buffer')
...
test('fuzz test', function (assert) {
    ...
    for (var i = 0, len = 100; i < len; ++i) {
        let bufferOptions = {};
        bufferOptions.size = randint(0x7FFFFFFF);
        let buffer = new Buffer(bufferOptions);
        console.log("TEST1")
        ...
        console.log("TEST3")
        assert.equal(buffer, data, 'fuzz test: ' + buffer.toString())

...
/**
 * Created by Mick on 22/03/2018.
 * Copyright © 2018 PrioApps. All rights reserved.
 */
public class BluetoothLeService extends Service {
    ...
    private int mConnectionState = Constant.STATE_DISCONNECTED;
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {
            ...
            if (newState == BluetoothProfile.STATE_CONNECTED) {
                intentAction = Constant.ACTION_GATT_CONNECTED;
                ...
                intentAction = Constant.ACTION_GATT_DISCONNECTED;
    ...
    private void broadcastUpdate(final String action,
        ...
        if (data != null && data.length > 0) {
            ...
            intent.putExtra(Constant.EXTRA_DATA, new String(data) + "\n" + stringBuilder.toString());
        }
        sendBroadcast(intent);
    }
